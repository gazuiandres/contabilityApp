function recoveryEmailTemplate(email: string, templateData: Record<string, string>) {
  return `
    ...
    <html>
     ...
     <body>
      <h1 style="font-weight: normal;text-align: center">Change your email</h1>

      <div style="text-align: center">
        <p style="font-weight: normal;text-align: center">Click <a href="${templateData.domain}/change-email?token=${templateData.token}">Here</a> to change your contability app email</p>
